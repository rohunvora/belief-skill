...
export function Profile({ handle }: { handle: string }) {
  ...
  const { user, calls, authorsSurfaced, tickersCovered, stats } = data;
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex items-start gap-3 mb-4">
        ...
        <div>
          ...
          {user.twitter && (
            <a href={`https://x.com/${user.twitter}`} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-600 mt-1 inline-block">
      ...
      <div className="flex items-baseline gap-4 mb-4 text-sm">
        <span className="text-gray-900 font-semibold">{stats.total} calls submitted</span>
      ...
      {authorsSurfaced.length > 0 && (
        <div className="mb-5">
          <div className="text-[10px] font-medium text-gray-400 uppercase tracking-wider mb-2">Authors Surfaced</div>
